...
def test_검증기_쓰기_올바른_입력_성공(validator):
    assert validator._validate_test(CORRECT_WRITE_SENTENCE) == True
...
def test_검증기_읽기_올바른_입력_성공(validator):
    assert validator._validate_test(CORRECT_READ_SENTENCE) == True
...
def test_검증기_앞뒤_공백_문자(validator):
    ...
    for wrong_sentence in wrong_sentences:
        assert validator._validate_test(wrong_sentence) == True
...
def test_검증기_대소문자_성공(validator):
    ...
    for correct_sentence in correct_sentences:
        assert validator._validate_test(correct_sentence) == True
